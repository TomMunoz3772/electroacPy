...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  2 09:15:10 2024

Free-field simulation of a floorstander speaker.
Radiating surfaces are represented as cones.
...
step_file = "../geo/step/floorstander_cone.step" 
cad = gtb.meshCAD(step_file, min_s, max_s)
cad.addSurfaceGroup("LF", [15, 19, 14, 18], 1, meshSize=343/5000/6)
cad.addSurfaceGroup("port", [17], 2)
cad.addSurfaceGroup("HF", [8, 16], 3, meshSize=343/5000/6)
cad.addSurfaceGroup("baffle", [1, 3, 4],
                    4, meshSize=343/3500/6)
cad.mesh("../geo/mesh/floorstander_cone")
...
#%% Observation setup 
floorstander.study_acousticBEM("free-field", "../geo/mesh/floorstander_cone.msh", 
...
#%% Sim
floorstander.run()
# ep.save("floorstander_cone", floorstander)
