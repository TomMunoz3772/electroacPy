...
This script shows how set up a sealed enclosure LEM/BEM simulation using pre-defined tools.
"""
...
system.lem_enclosure_2("LF_sealed",  # name used as a reference for simulations
                       Vb=13.56e-3,
                       setDriver="LF",     # need to set lem_driver into enclosure
                       ref2bem=1)          # reference to BEM groups, see mesh_from_python file

# STUDY SETUP
system.study_exteriorBEM("free-field",              # name of study, multiple studies can be defined
                         meshPath=mesh,                   # self-explanatory
                         acoustic_radiator="LF_sealed",   # radiators used in simulation, must be referenced to BEM boundaries
...
# save results
ep.save("saved_data/03_sealed", system)
