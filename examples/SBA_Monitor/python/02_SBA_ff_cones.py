...
Radiating surfaces are represented as cones -> effects of diffraction.
...
step_file = "../geo/step/SBA_M_ext_cones.step" 
cad = gtb.meshCAD(step_file, min_s, max_s)
cad.addSurfaceGroup("LF", [14, 9, 3], 1, meshSize=343/8000/6)
cad.addSurfaceGroup("port", [8], 2)
cad.addSurfaceGroup("HF", [19, 20], 3, meshSize=343/8000/6)
cad.addSurfaceGroup("baffle", [16, 17, 18, 2, 
                               5, 6, 7, 13], 4, meshSize=343/3500/6)
cad.mesh("../geo/mesh/SBA_M_ext_cones")
...
#%% Sim
sba.run()
# ep.save("SBA_M_cones", sba)  # save simulation
